...
class UpdateSiswaRequest extends FormRequest
{
    ...
    {
        $siswaId = $this->route('student') ? $this->route('student')->idsiswa : null;

        return [
            'nis' => [
                'required', 'string', 'max:20',
                Rule::unique('tbl_siswa', 'nis')->ignore($siswaId, 'idsiswa'),
            ],
            'nisn' => [
                'required', 'string', 'max:20',
                Rule::unique('tbl_siswa', 'nisn')->ignore($siswaId, 'idsiswa'),
            ],
            ...
            // 'idprogramkeahlian' => 'nullable|integer|exists:tbl_programkeahlian,idprogramkeahlian', // DIHAPUS/DIKOMENTARI
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            // ... (pesan lainnya sama seperti StoreSiswaRequest) ...
